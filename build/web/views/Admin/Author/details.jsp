        ...
        <div class="card my-2 mx-2">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a type="button" class="btn btn-primary btn-lg" href="createAuthor?authorId=${requestScope.author.authorId}">
                            Update</a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" class="form-control" data-error="title" 
                                       ...
                                       value="${requestScope.author.authorName}" required readonly disabled>
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <input type="date" class="form-control" data-error="dob" 
                                       ...
                                       value="${requestScope.author.dob}" required readonly disabled>
