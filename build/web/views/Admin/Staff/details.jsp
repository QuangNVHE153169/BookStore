        ...
        <div class="card my-2 mx-2">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a type="button" class="btn btn-secondary btn-lg" href="admin-manage-staff?userId=${requestScope.staff.userID}">
                            Update</a>
                    </div>
                </div>
            </div>
                ...
                <form method="POST" action="admin-manage-staff" id="form-create">
                    <div class="col">
                        <c:if test="${requestScope.staff != null}">
                            <div class="row">
                                <div class="col-6">
                                    <strong> <label for="category-film" class="col-form-label">Sale Admin ID: </label> ${requestScope.staff.userID}</strong>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" class="form-control req" data-error="fullName" 
                                       ...
                                       value="${requestScope.staff.fullName}" readonly disabled>
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" class="form-control req" data-error="email" 
                                       ...
                                       value="${requestScope.staff.email}" readonly disabled>
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <input type="text" class="form-control req" data-error="phone" 
                                       ...
                                       value="${requestScope.staff.phone}" readonly disabled>
                            ...
                            <div class="col-6">
                                ...
                                <input type="date" class="form-control req" data-error="dob" 
                                       ...
                                       value="${requestScope.staff.dob}" readonly disabled>
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <input type="radio" data-error="gender" 
                                       oninput="validateInputBox(this)" name="gender"
                                       value="0" 
                                       <c:if test="${requestScope.staff.gender == 0}">checked</c:if> readonly disabled/>Female
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control" data-error="description" 
                                              oninput="validateInputBox(this)" name="description" readonly disabled>${requestScope.staff.description}</textarea>
