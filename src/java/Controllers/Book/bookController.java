...
public class BookController extends HttpServlet {
    ...
    public void getBook(HttpServletRequest request, HttpServletResponse response, String redirectPage) throws IOException, ServletException {
        BookDAO bDao = new BookDAO();
        ...
        if (b != null) {
            ...
            request.getSession().setAttribute("msg", "Book is not Exist. Redirect to Create Page");
